    ...
    <div className="pt-00">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-8">{t('services.consulting.benefits.title')}</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {t('services.consulting.benefits.items', { returnObjects: true }).map((benefit: string, index: number) => (
            ...
            {['diagnosis', 'planning', 'implementation'].map((phase) => (
              <div key={phase} className="bg-white p-8 rounded-xl shadow-lg">
                ...
                <ul className="space-y-4">
                  {t(`services.methodology.phases.${phase}.steps`, { returnObjects: true }).map((step: string, stepIndex: number) => (
