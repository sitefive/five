...
const Revitalizacao = () => {
  ...
  const benefits = t('services.revitalization.page.benefits.items', { returnObjects: true }) || [];
  const methodologyPhases = ['diagnosis', 'planning', 'implementation', 'training'];

  return (
    <div className="pt-00">
      <ParallaxHeader
        title={t('services.revitalization.page.title')}
        description={t('services.revitalization.page.description')}
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-8">{t('services.revitalization.page.benefits.title')}</h2>
        ...
        {/* Methodology Section */}
        <section>
          <h2 className="text-3xl font-bold mb-8">{t('services.revitalization.page.methodology.title')}</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {methodologyPhases.map((phase) => {
              const steps = t(`services.revitalization.page.methodology.phases.${phase}.steps`, { returnObjects: true }) || [];
              return (
                <div key={phase} className="bg-white p-8 rounded-xl shadow-lg">
                  <h3 className="text-2xl font-semibold mb-6">
                    {t(`services.revitalization.page.methodology.phases.${phase}.title`)}
                  </h3>
