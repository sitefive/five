...
const Contact = () => {
  return (
    <div className="pt-00">
      <ParallaxHeader
        title="Contato"
        description="Entre em contato conosco e descubra como podemos ajudar seu negócio a crescer."
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          <div className="flex flex-col items-center justify-end h-full text-center">
            ...
            <p className="text-gray-700 text-lg leading-relaxed max-w-xl mb-10">
              A FIVE é uma consultoria especializada em impulsionar o crescimento de empresas por meio de soluções personalizadas e estratégias inovadoras. Atuamos lado a lado com nossos clientes para transformar desafios em resultados sustentáveis e duradouros.
            </p>
