        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/#experts" className="hover:text-white transition-colors duration-300">
                  {t('menu.about')}
                </Link>
              </li>
              <li>
                <Link to="/servicos" className="hover:text-white transition-colors duration-300">
                  {t('menu.services')}
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/contato" className="hover:text-white transition-colors duration-300">
                  {t('menu.contact')}
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-gray-800 text-sm text-gray-400">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4 mt-4 md:mt-0">
              ...
              <Link to="/terms-of-use" className="hover:text-white transition-colors duration-300">
                {t('footer.termsOfUse')}
              </Link>
            </div>
          </div>
